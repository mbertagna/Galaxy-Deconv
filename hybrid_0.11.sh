...
time python train.py --model Unrolled_ADMM --n_iters 2 --n_epochs 20 --loss L1_FPFSCoeffLoss --batch_size 64 --lr 1e-4 --aux_weight 0.11 --loss_coeffs "m20" "m22c" "m22s" "m40" "m42c" "m42s" "m44c" "m44s" 2>&1 | tee "train_output_${SLURM_JOB_ID}.txt"